...
if (write_out) {
  library(readr)
  # write_csv(all_output, "inst/all_output/sim_deperr_lognormalbig_n150_gridloc.csv")
  write_csv(summ_output, "inst/output/sim_deperr_lognormalbig_n150_gridloc.csv")
}
