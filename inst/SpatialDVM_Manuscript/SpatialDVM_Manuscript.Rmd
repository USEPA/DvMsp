...
@de1990model give an early comparison of the paradigms for spatial data, quashing the belief that classical sampling-based methods could not be used for spatially correlated data. Thereafter, several comparisons between model-based and design-based for spatial data have been considered, but they tend to compare spatial models to IRS (Independent Random Sampling) or SIRS (stratified IRS) [@brus1997random]. No comparison has been made between spatial models and spatially balanced design-based approaches.
