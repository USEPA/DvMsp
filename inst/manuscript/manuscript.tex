...
The simulated and real data were used in distinct ways to answer
distinct questions. We used the simulated data to compare the
sampling-inference combinations across many realized populations (from
the same data-generating stochastic process) and random samples. We used
the real data to compare the sampling-inference combinations within a
single realized population but across random samples. With the simulated
data, we were in control of the data-generating stochastic process and
the random sampling process. With the real data, we were only in control
