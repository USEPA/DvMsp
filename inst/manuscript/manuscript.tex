...
Corvallis, Oregon, 97331}
  ...
  \item
    ...
    model-based analyses tend to outperform design-based analyses, even
    when the data are skewed (and by consequence, the model-based
    ...
    that the sampling choice (spatially balanced samples versus
    non-spatially balanced samples) is most important when using a
    design-based analysis.
  \item
    There are many benefits and drawbacks practitioners must consider when
    choosing between design-based and model-based approaches for finite
    population spatial data. We provide relevant background
    contextualizing each approach and study their properties in a variety
    of scenarios, making recommendations for use based on the
