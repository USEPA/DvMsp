...
\usepackage{bm} \usepackage{bbm} \usepackage{color} \DeclareMathOperator{\var}{{var}} \DeclareMathOperator{\cov}{{cov}} \usepackage{caption} \usepackage{subcaption}
...
layout with ``IRS-Design'' as the baseline.
...
Figure \ref{fig:merc} shows that mercury concentration is right-skewed,
...
spatial correlation, with high mercury concentrations in lakes in the
northeast and north central United States. The realized mean mercury
concentration in the 986 lakes is 103.2 ng / g. TALK ABOUT EMPIRICAL
SEMIVARIOGRAM IN THIS PARAGRAPH.
