...
Next we present tables summarizing mean estimation bias (design-based) or mean prediction bias (model-based), mean standard errors, root-mean-squared error (design-based) or root-mean-squared-prediction error (model-based), and 95% confidence interval coverage (design-based) or 95% prediction interval coverage (model-based) for all 36 simulation scenarios.
```{r}
