...
We used a simulation study to investigate performance of four sampling-analysis combinations: Independent Random Sampling (IRS) with a design-based analysis, called "IRS-Design" (IRS samples are not spatially balanced because population units are selected independent of their spatial locations); IRS with a model-based analysis, called "IRS-Model"; GRTS sampling with a design-based analysis, called "GRTS-Design"; and GRTS sampling with a model-based analysis, called "GRTS-Model". These combinations are also provided in Table \ref{tab:designanalysis}.
