...
Figure \ref{fig:figeff} shows the relative rMS(P)E of the four approaches from Table \ref{tab:designanalysis} using the random location layout with "IRS-Design" is the baseline. More formally, the relative rMS(P)E is defined as
\begin{equation*}
...
The average bias was nearly zero for all four combinations in all 36 scenarios, so we omit a visualization of those results here. Tables for average bias in all 36 simulation scenarios are provided in the supplementary material.
